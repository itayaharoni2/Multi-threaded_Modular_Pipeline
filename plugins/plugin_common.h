...
typedef struct
{
    ...
    consumer_producer_t *queue;                    // A pointer to its input queue
 ...
 */
const char *plugin_get_name(void) __attribute__((visibility("default")));
 ...
 * @return NULL on success, error message on failure
 */
const char *plugin_init(int queue_size) __attribute__((visibility("default")));

/**
 * Finalize the plugin - drain queue and terminate thread gracefully (i.e. pthread_join)
 * @return NULL on success, error message on failure
 */
const char *plugin_fini(void) __attribute__((visibility("default")));
 ...
 * @return NULL on success, error message on failure
 */
const char *plugin_place_work(const char *str) __attribute__((visibility("default")));
 ...
 */
void plugin_attach(const char *(*next_place_work)(const char *)) __attribute__((visibility("default")));
 ...
 * @return NULL on success, error message on failure
 */
const char *plugin_wait_finished(void) __attribute__((visibility("default")));
